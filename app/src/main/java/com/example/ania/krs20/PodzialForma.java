...
public class PodzialForma extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_podzial_forma);
        Toolbar toolbar = (Toolbar) findViewById(R.id.toolbar);
        setSupportActionBar(toolbar);

        firmy = (ListView)findViewById(R.id.listView5);
        wysz = (EditText)findViewById(R.id.editText6);
        ...
        btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(wysz.getText().toString().equals("1")) {
                    new JASONTask().execute("https://api-v3.mojepanstwo.pl/dane/krs_podmioty.json?conditions[krs_podmioty.forma_prawna_typ_id]=" + wysz.getText().toString());
                }else{
                    if(wysz.getText().toString().equals("2")){
                        new JASONTask().execute("https://api-v3.mojepanstwo.pl/dane/krs_podmioty.json?conditions[krs_podmioty.forma_prawna_typ_id]=" + wysz.getText().toString());
                    }else{
                        if(wysz.getText().toString().equals("3")){
                            new JASONTask().execute("https://api-v3.mojepanstwo.pl/dane/krs_podmioty.json?conditions[krs_podmioty.forma_prawna_typ_id]=" + wysz.getText().toString());
                        }else{
        ...
        btnNext.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick (View v){
                i++;
                new JASONTask().execute("https://api-v3.mojepanstwo.pl/dane/krs_podmioty.json?conditions%5Bkrs_podmioty.forma_prawna_typ_id%5D=" +  wysz.getText().toString() + "&_type=objects&page=" + i);
            }
        });
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_settings) {
            Intent glo = new Intent(PodzialForma.this, MainActivity.class);
            startActivity(glo);
            return true;
        }
